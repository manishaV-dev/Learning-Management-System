    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-2xl font-semibold text-lg text-gray-800">
        ...
        <div className="z-10 max-w-[424px] shadow-2xl rounded-lg md:rounded-none overflow-hidden bg-white min-w-[200px] sm:min-w-[380px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap3 items-center pt-2">
              ...
              <p className="ml-2 md:text-lg text-gray-500 line-through">
                {currency}
                {courseData.coursePrice}
              </p>
              <p className="ml-2 md:text-base text-gray-700">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium cursor-pointer hover:bg-blue-700">
